                            ...
                            <div class="row">
                                <div class="col col-lg-6">
                                    <div class="product_details_image p-0">
                                        <img src="{{('frontend/images/shop/product_img_12.png')}}" alt>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="product_details_content">
                                        ...
                                        <p>
                                            It is a long established fact that a reader will be distracted eget velit. Donec
                ...
                <div class="col-lg-9 order-lg-3">
                    <div class="best-selling-products">
                        ...
                        <div class="product-area clearfix">
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{('frontend/images/shop/product-img-21.png')}}" alt>
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{('frontend/images/shop/product-img-22.png')}}" alt>
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{('frontend/images/shop/product-img-23.png')}}" alt>
                                    <span class="theme-badge">Sale</span>
                                    <div class="actions">
                                        <ul>
                                            <li>
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{('frontend/images/shop/product-img-24.png')}}" alt>
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{('frontend/images/shop/product-img-25.png')}}" alt>
                                    <div class="actions">
                                        <ul>
                                            <li>
                                                <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px"
                        ...
                        <div class="top_category_carousel2" data-slick='{"dots": false}'>
                                ...
                                <div class="category_boxed">
                                    <a href="#!">
                                        <span class="item_image">
                                            <img src="{{('frontend/images/categories/category_1.png')}}" alt="image_not_found">
                                        </span>
                            ...
                            <div class="slider_item">
                                <div class="category_boxed">
                                    <a href="#!">
                                        <span class="item_image">
                                            <img src="{{('frontend/images/categories/category_2.png')}}" alt="image_not_found">
                                        </span>
                            ...
                            <div class="slider_item">
                                <div class="category_boxed">
                                    <a href="#!">
                                        <span class="item_image">
                                            <img src="{{('frontend/images/categories/category_3.png')}}" alt="image_not_found">
                                        </span>
                            ...
                            <div class="slider_item">
                                <div class="category_boxed">
                                    <a href="#!">
                                        <span class="item_image">
                                            <img src="{{('frontend/images/categories/category_4.png')}}" alt="image_not_found">
                                        </span>
                            ...
                            <div class="slider_item">
                                <div class="category_boxed">
                                    <a href="#!">
                                        <span class="item_image">
                                            <img src="{{('frontend/images/categories/category_5.png')}}" alt="image_not_found">
                                        </span>
                    ...
                    <div class="product-sidebar">
                        <div class="widget latest_product_carousel">
                            ...
                            <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{('frontend/images/latest_product/latest_product_1.png')}}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{('frontend/images/latest_product/latest_product_2.png')}}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{('frontend/images/latest_product/latest_product_3.png')}}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{('frontend/images/latest_product/latest_product_4.png')}}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                        ...
                        <div class="widget product-add">
                            <div class="product-img">
                                <img src="{{('frontend/images/shop/product_img_10.png')}}" alt>
                            </div>
                            <div class="details">
                                <h4>iPad pro</h4>
        ...
        <div class="container">
            <div class="row promotion_banner_wrap">
                <div class="col col-lg-6">
                    <div class="promotion_banner">
                        <div class="item_image">
                            <img src="{{('frontend/images/promotion/banner_img_1.png')}}" alt>
                        </div>
                        <div class="item_content">
                ...
                <div class="col col-lg-6">
                    <div class="promotion_banner">
                        <div class="item_image">
                            <img src="{{('frontend/images/promotion/banner_img_2.png')}}" alt>
                        </div>
                        <div class="item_content">
            ...
            <div class="row newarrivals_products">
                ...
                <div class="col col-lg-7">
                    <div class="new-arrivals-grids clearfix">
                        <div class="grid">
                            <div class="product-pic">
                                <img src="{{('frontend/images/shop/product-img-28.png')}}" alt>
                                <div class="actions">
                                    <ul>
                                        <li>
                                            <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px"
                        ...
                        <div class="grid">
                            <div class="product-pic">
                                <img src="{{('frontend/images/shop/product-img-26.png')}}" alt>
                        ...
                        <div class="grid">
                            <div class="product-pic">
                                <img src="{{('frontend/images/shop/product-img-27.png')}}" alt>
            ...
            <div class="brand_carousel">
                <div class="slider_item">
                    <a class="product_brand_logo" href="#!">
                        <img src="{{('frontend/images/brand/brand_1.png')}}" alt="image_not_found">
                        <img src="{{('frontend/images/brand/brand_1.png')}}" alt="image_not_found">
                    </a>
                </div>
                <div class="slider_item">
                    <a class="product_brand_logo" href="#!">
                        <img src="{{('frontend/images/brand/brand_2.png')}}" alt="image_not_found">
                        <img src="{{('frontend/images/brand/brand_2.png')}}" alt="image_not_found">
                    </a>
                </div>
                <div class="slider_item">
                    <a class="product_brand_logo" href="#!">
                        <img src="{{('frontend/images/brand/brand_3.png')}}" alt="image_not_found">
                        <img src="{{('frontend/images/brand/brand_3.png')}}" alt="image_not_found">
                    </a>
                </div>
                <div class="slider_item">
                    <a class="product_brand_logo" href="#!">
                        <img src="{{('frontend/images/brand/brand_4.png')}}" alt="image_not_found">
                        <img src="{{('frontend/images/brand/brand_4.png')}}" alt="image_not_found">
                    </a>
                </div>
                <div class="slider_item">
                    <a class="product_brand_logo" href="#!">
                        <img src="{{('frontend/images/brand/brand_5.png')}}" alt="image_not_found">
                        <img src="{{('frontend/images/brand/brand_5.png')}}" alt="image_not_found">
                    </a>
                </div>
            </div>
                ...
                <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                    <div class="slider_item col">
                        <div class="viewed_product_item">
                            <div class="item_image">
                                <img src="{{('frontend/images/viewed_products/viewed_product_img_1.png')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                        ...
                        <div class="viewed_product_item">
                            <div class="item_image">
                                <img src="{{('frontend/images/viewed_products/viewed_product_img_2.png')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                    ...
                    <div class="slider_item col">
                        <div class="viewed_product_item">
                            <div class="item_image">
                                <img src="{{('frontend/images/viewed_products/viewed_product_img_3.png')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                        ...
                        <div class="viewed_product_item">
                            <div class="item_image">
                                <img src="{{('frontend/images/viewed_products/viewed_product_img_4.png')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                    ...
                    <div class="slider_item col">
                        <div class="viewed_product_item">
                            <div class="item_image">
                                <img src="{{('frontend/images/viewed_products/viewed_product_img_5.png')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                        ...
                        <div class="viewed_product_item">
                            <div class="item_image">
                                <img src="{{('frontend/images/viewed_products/viewed_product_img_6.png')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
